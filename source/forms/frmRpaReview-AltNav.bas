        ...
        Begin Section
            ...
            Begin
                ...
                Begin Label
                    ...
                    ForeColor =12349952
                    Name ="Label78"
                    Caption ="Document Integrity Unit (DIU)"
                    GridlineColor =10921638
                ...
                Begin CommandButton
                    ...
                    TabIndex =8
                    ForeColor =4210752
                    Name ="cmdDiuInitialStart"
                    Caption ="DIU Check-Out"
                    OnClick ="[Event Procedure]"
                    GridlineColor =10921638
                ...
                Begin CommandButton
                    ...
                    TabIndex =11
                    ForeColor =4210752
                    Name ="cmdDiuInitialComplete"
                    Caption ="DIU Review Complete"
                    OnClick ="[Event Procedure]"
                    GridlineColor =10921638
...
Private Sub cmdDiuInitialComplete_Click()
...
'    Passes in the Procedure Name.  Needs to be adjusted for each procedure. Thanks VBA.
    PushCallStack Me.name & "." & "cmdDiuInitialComplete_Click"
...
Private Sub cmdDiuInitialStart_Click()
'///Error Handling
    If gcfHandleErrors Then On Error GoTo PROC_ERR
    PushCallStack Me.name & "." & "cmdDiuInitialStart_Click"
'///Error Handling

'///Code
    StartReview "DIU Initial"
'///Code
...
'    tblReviewTypes
    EnableFormArea "DIU Initial"
    EnableFormArea "OCC Review"
    EnableFormArea "PAGS Review"
    EnableFormArea "DIU RPA Eligibility"
...
'    RePaintForm.
    Select Case AreaName
        Case "DIU Initial"
            ...
            Me.tbDiuNotes.Enabled = CanEnable
            Me.cmdDiuInitialStart.Enabled = CanEnable
            Me.cmdDiuInitialComplete.Enabled = CanEnable
        ...
        Case "DIU RPA Eligibility"
            Me.tbDiuDetermination.Enabled = False 'entered by import
