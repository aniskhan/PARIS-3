...
Begin Form
    ...
    RecSrcDt = Begin
        0x36be6bf716b7e440
    End
    RecordSource ="SELECT [fqryNavMainUserPositions].[StaffID], [fqryNavMainUserPositions].[Disaste"
        "rID], [fqryNavMainUserPositions].[Position Description] FROM fqryNavMainUserPosi"
        "tions; "
