CREATE TABLE [tblRFI] (
  [RfiID] AUTOINCREMENT CONSTRAINT [Index_6B124E94_7CAC_4416] UNIQUE  CONSTRAINT [Index_7EAF57AC_6409_49AD] UNIQUE  CONSTRAINT [Index_93BA47FB_86F2_4131] UNIQUE  CONSTRAINT [Index_DF23F427_1A8B_4741] UNIQUE  CONSTRAINT [PrimaryKey] PRIMARY KEY  UNIQUE  NOT NULL ,
