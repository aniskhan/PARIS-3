CREATE TABLE [tblProjectionUpdates] (
  [ID] AUTOINCREMENT CONSTRAINT [Index_7020F39F_2D56_4DA7] UNIQUE  CONSTRAINT [Index_925BCB12_F2DB_4CAF] UNIQUE  CONSTRAINT [Index_D84C2638_EB51_4ADE] UNIQUE  CONSTRAINT [Index_E8CDCD8F_162B_4F27] UNIQUE  CONSTRAINT [PrimaryKey] PRIMARY KEY  UNIQUE  NOT NULL ,
