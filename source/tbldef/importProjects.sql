CREATE TABLE [importProjects] (
  [ID] AUTOINCREMENT CONSTRAINT [ID] PRIMARY KEY  UNIQUE  NOT NULL  CONSTRAINT [Index_2FFF6196_1960_4DD9] UNIQUE  CONSTRAINT [Index_7F8243E8_61D9_4830] UNIQUE  CONSTRAINT [Index_882C8658_A51B_4627] UNIQUE  CONSTRAINT [Index_D6469C48_4262_4DAB] UNIQUE ,
