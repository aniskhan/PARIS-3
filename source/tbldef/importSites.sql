CREATE TABLE [importSites] (
  [ID] AUTOINCREMENT CONSTRAINT [ID] PRIMARY KEY  UNIQUE  NOT NULL  CONSTRAINT [Index_17A793F8_F513_4D4A] UNIQUE  CONSTRAINT [Index_71B4F11B_A300_4638] UNIQUE  CONSTRAINT [Index_7418C6E5_1AB9_48EE] UNIQUE  CONSTRAINT [Index_F682D4D8_157E_44BF] UNIQUE ,
  [Line #] VARCHAR (255),
