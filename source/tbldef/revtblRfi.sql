CREATE TABLE [revtblRfi] (
  [ReviewID] AUTOINCREMENT CONSTRAINT [Index_316C0C13_343A_475E] UNIQUE  CONSTRAINT [Index_8E458F7B_4E65_4660] UNIQUE  CONSTRAINT [Index_929815FE_8F44_4335] UNIQUE  CONSTRAINT [Index_9DA4540F_3C47_4105] UNIQUE  CONSTRAINT [PrimaryKey] PRIMARY KEY  UNIQUE  NOT NULL ,
