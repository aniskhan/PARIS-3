...
Public Const AlwayUseAltSource As Boolean = False        ' Change Value when testing. True will force the alt record set to be used.
                                                        ' False will check if current set has data before using Alt
Public Const EnableFormLocking As Boolean = False       ' Change Value for testing. False will suppress all form enable/disable.
